...
6. Rights: source URL, attribution, license, public-domain status, reuse restriction, or citation rule.

A project can rename or reduce these lanes, but it should not collapse source evidence, interpretation, and rights into one undifferentiated visual layer.
...
Refused claim types unless separately proven:

- Frequency equals importance.
- Corpus visibility equals all usage.
- Earliest detected point equals first historical use.
- Semantic grouping equals dictionary definition.
- Search attention equals lived reality, legal meaning, clinical meaning, or cultural value.
- Missing data proves historical absence.
...
- Subject-first hero with the word, object, or topic visible immediately.
- Compact metadata table beside or below the title.
- Panel progress row for multi-chart pages.
- Section headers with eyebrow, title, and short interpretive note.
- Source ledger and method notes as first-class sections, not buried appendices.
