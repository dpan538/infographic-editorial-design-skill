...
Download or clone this repository, then install it as a Codex / ChatGPT skill by uploading the folder or placing it in your local skills directory.
...
```text
Use $infographic-editorial-design to critique this data page before publication. Focus on whether the design overclaims, hides uncertainty, confuses source types, or weakens the reading path.
```
